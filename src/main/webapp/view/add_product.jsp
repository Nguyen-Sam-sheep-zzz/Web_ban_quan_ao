            ...
            <form method="post">
                <table>
                    <tr>
                        ...
                        <td><input type="text" name="nameProduct" placeholder="Enter product name"></td>
                    </tr>
                    <tr>
                        <th>URL of image:</th>
                        <td><input type="text" name="urlImage" placeholder="Enter image URL"></td>
                    </tr>
                    <tr>
                        <th>Description of product:</th>
                        <td>
                            <textarea name="descriptionProduct" placeholder="Enter product description"></textarea>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td><select name="size" >
                            <option value="nothing">Please choose size</option>
                    ...
                    <tr>
                        ...
                        <td><select name="category">
                            <option value="nothing">Please choose category</option>
